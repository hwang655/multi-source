...
para = rbind(para,c(30,50,50,10,1,1,1,1,1))
para = rbind(para,c(30,50,50,1,10,1,1,1,1))
para = rbind(para,c(30,50,50,1,1,10,1,1,1))
para = rbind(para,c(30,50,50,1,1,1,10,1,1))
para = rbind(para,c(30,50,50,1,1,1,1,10,1))
para = rbind(para,c(30,50,50,1,1,1,1,10,10))
para = rbind(para,c(30,100,10,1,1,1,1,1,1))
para = rbind(para,c(30,100,10,10,1,1,1,1,1))
para = rbind(para,c(30,100,10,100,1,1,1,1,1))
para = rbind(para,c(30,100,10,1,1,1,10,1,1))
para = rbind(para,c(30,100,10,10,1,1,10,1,1))
para = rbind(para,c(30,100,10,100,1,1,10,1,1))
para = rbind(para,c(30,100,10,1,1,1,1,10,1))
para = rbind(para,c(30,100,10,10,1,1,1,10,1))
para = rbind(para,c(30,100,10,100,1,1,1,10,1))
para = rbind(para,c(30,100,10,1,10,1,1,1,1))
para = rbind(para,c(30,100,10,1,100,1,1,1,1))
para = rbind(para,c(30,100,10,1,1,10,1,1,1))
para = rbind(para,c(30,100,10,1,1,100,1,1,1))
para = rbind(para,c(30,100,10,1,1,10,1,10,1))
para = rbind(para,c(30,100,10,1,1,100,1,10,1))
para = rbind(para,c(30,100,10,1,1,10,10,1,1))
para = rbind(para,c(30,100,10,1,1,100,10,1,1))
seed.seq = 1:n.rep
