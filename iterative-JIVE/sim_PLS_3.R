...
for(case in case.seq){
  ...
  file.name = paste0("multi_source_result_pls_n=",n,"_p1=",p1,"_p2=",p2,"_a=",alpha[1],"_a1=",alpha1[1],"_a2=",alpha2[1],"_scale1=",para[case,7],"_scale2=",para[case,8],"_sigma2")
  # write.table(result, file = file.name, sep = ',', append = T, col.names = F, row.names = F)
  save(result,file = paste0(file.name,".rData"))  
  file.name = paste0("multi_source_est_result_pls_n=",n,"_p1=",p1,"_p2=",p2,"_a=",alpha[1],"_a1=",alpha1[1],"_a2=",alpha2[1],"_scale1=",para[case,7],"_scale2=",para[case,8],"_sigma2")
