...
# setwd(current)
n.rep=30
para = matrix(0,nrow=6,ncol=8)
para[1,] = c(80,100,10,1,1,100,1,5)
para[2,] = c(80,100,10,1,1,1000,1,5)
para[3,] = c(80,100,10,10,1,10,1,10)
para[4,] = c(80,100,10,10,1,100,1,10)
para[5,] = c(80,100,10,100,1,100,1,100)
para[6,] = c(80,100,10,100,1,1000,1,100)
seed.seq = 1:n.rep
